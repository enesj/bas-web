...
(defn rows-naredbe [data screen]
	(into {} (mapv (fn [x] (let [{:keys [JUSId JUSopis Glasnik Direktiva Link-n Link-d Naredba Locked]} x
													 ...
													 {JUSId {:id          JUSId
																	 ...
																	 ;:click     set-path
																	 :level       :0
																	 :tooltip     {:veze (nth count-veza 2) :gotovo (last count-veza)}}})) data)))
...
(defn rows-jus [data screen] (into {} (mapv (fn [x] (let [{:keys [JUSId JUSopis JUSgodina Locked Naredba Mandatory]} x
																													count-veza (count-veza JUSId)]
																											(if (= Naredba 0)
																												{JUSId {:id       JUSId
																															...
																															[v-box
																															 ...
																															 [[v-split
																																 ...
																																 [v-box
																																	...
																																	:width "100%"
																																	:children
																																	[(if path [title :level :level3 :style {:font-weight "bold" :align-self "center" :font-family "Courier New" :color (:0 colors)} :label (str (second (opis-level :1)) " povlači:")])
																																	 [scroller
																																		:v-scroll :auto
																																		:height "100%"
																																		:scroll :auto
																																 ...
																																 [v-box
																																	...
																																	:style {:margin-left "auto" :margin-right "auto"}
																																	:children
																																	[(if path [title :level :level3 :style {:font-weight "bold" :align-self "center" :font-family "Courier New" :color (:1 colors)} :label (str (second (opis-level :2)) " povlači:")])
																																	 [scroller
																																		:v-scroll :auto
																																		:height "100%"
																																		:scroll :auto
