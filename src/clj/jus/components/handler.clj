(ns jus.components.handler
	(:require [compojure.core :refer [defroutes]]
						...
						[jus.routes.home :refer [home-routes]]
						[jus.routes.jus :refer [jus-routes]]
						[jus.routes.cc :refer [cc-routes]]
						[jus.routes.user :refer [user-routes registration-routes]]
						[jus.middleware :refer [load-middleware]]))
